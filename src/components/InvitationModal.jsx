...
const CONVERT_KIT_API_KEY = "YBjGBUhGWuoS4pVZ1HAllw";
const CONVERT_KIT_API_SECRET = "E2ZsHOKP5ineMh7AmswBTqq9FmZkFGPsiCI2KHqZkkY";

export const InvitationModal = ({ setIsOpen }) => {
  const apiUrl = `https://api.convertkit.com/v3/subscribers?api_secret=${CONVERT_KIT_API_SECRET}`;
  ...
  React.useEffect(() => {
    const getData = async () => {
      ...
      console.log(json)
      setTotal(json.total_subscribers)
    }
    getData()
  }, [])
  return (
